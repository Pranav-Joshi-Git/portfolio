        ...
        {experiences.map((exp, i) => (
          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '0.25rem', marginBottom: '0.25rem' }}>
              <div>
                <span style={{ fontWeight: 600, fontSize: '1.0625rem', color: 'var(--color-text)' }}>
                  {exp.title}
                </span>
            ...
            {/* Recognition — styled as achievement */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {exp.recognition.map((award, k) => (
                <div key={k} style={{
                  ...
                  <span style={{ fontSize: '0.8125rem', fontWeight: 500, color: 'var(--color-text)', lineHeight: 1.5 }}>
                    {award}
                  </span>
                </div>
              ))}
